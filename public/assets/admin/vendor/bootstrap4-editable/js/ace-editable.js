...
(function ($) {
    ...
    var Image = function (options) {
        ...
        if(options.image){
            console.log('ddddddddddddd',options.image);
    ...
    $.extend(Image.prototype, {
        ...
        **/
        ...
        render: function() {
            ...
            this.$file.ace_file_input(this.options.image).on('change', function(el){
                if(self.$file.val() || self.$file.data('ace_input_files'))
                {
                    var reader = new FileReader();
                    reader.onload = function (e) {
                        self.$input.val(e.target.result)
                    };
